...
final class ChuckPositionsAllTests: XCTestCase {
    var imp: ChuckPositionsAll!
    ...
    func testDetectViaMain() throws {
        ...
        _ = actual.map { key, value in
            XCTAssertNotNil(key as? ChuckPositionsAll)
